...
path = "/home/rgukt/Desktop/criotam/friut/shape/IMG_20190325_110144.jpg"
...
width = 3.65   ## in inches

print(len(cnts))

for c in cnts:
	if cv2.contourArea(c)<230000:
		continue
	...
	if pixels_per_inch is None:
		pixels_per_inch = dA / width               ## reference size
	print(pixels_per_inch)
	...
	cv2.putText(original, "{:.2f}cm".format(dimB),
		(int(topright_bottomrightX -10 ), int(topright_bottomrightY-10)), cv2.FONT_HERSHEY_SIMPLEX,
		0.5, (255, 255, 255), 2)
